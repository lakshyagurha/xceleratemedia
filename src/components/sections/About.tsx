        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
              We are a next-generation influencer marketing agency that bridges the gap between creative storytelling and data-driven performance. 
            </p>
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 leading-relaxed">
              Founded on the belief that influence is the new currency, we help brands navigate the complex creator economy to build authentic connections that convert. From strategy to execution, we are your partners in growth.
            </p>
